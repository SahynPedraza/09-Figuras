 ...
 *
 */
public class VentanaACirculo extends JFrame implements ActionListener {
	...
	private PCirculo acir = new PCirculo();
	
	/**
	 * Dimenciones de ventana
	 */
	public VentanaACirculo(){
	...
	public void actionPerformed(ActionEvent arg0){
		Object boton = arg0.getSource();
			double s = acir.Acirculo(Double.parseDouble(txtN1.getText()));
			lbResultado.setText(String.format("El Area %s = %f", txtN1.getText(), s));
