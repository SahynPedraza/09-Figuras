...
public class VentanaCuadrado extends JFrame implements ActionListener{
	...
	/**
	 * Objeto op de la clase PCuadrado que es llamana para calcular areas
	 */	
private PCuadrado op = new PCuadrado();
 ...
 */	
	...
	public void actionPerformed(ActionEvent arg0) {
		double r = op.Pcuadrado(Double.parseDouble(txtN1.getText()));
		lbResultado.setText(String.format("El perimetro %s = %f metros cuadrados", txtN1.getText(), r)); 		
	}
}
