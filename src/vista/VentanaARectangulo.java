 ...
 *
 */
public class VentanaARectangulo extends JFrame implements ActionListener {
	/**
	...
	private PRectangulo arec = new PRectangulo();
	
/**
 * Dimenciones de ventana
 */
	public VentanaARectangulo(){
 ...
 */
	public void actionPerformed(ActionEvent arg0) {
		double r = arec.Arectangulo(Double.parseDouble(txtN1.getText()), Double.parseDouble(txtN2.getText()));
