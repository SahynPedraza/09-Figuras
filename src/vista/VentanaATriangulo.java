 ...
 *
 */
public class VentanaATriangulo extends JFrame implements ActionListener {
	/**
	...
	private PTrianguloIsosceles atri = new PTrianguloIsosceles();
	
	/**
	 * Dimenciones de ventana
	 */	
	public VentanaATriangulo(){
	...
	public void actionPerformed(ActionEvent arg0) {
		double r = atri.Atriangulo(Double.parseDouble(txtN1.getText()), Double.parseDouble(txtN2.getText()));
